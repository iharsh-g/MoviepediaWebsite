...
function TopRatedMovies() {
    const {getMovies, movies, loading} = useMovies("top_rated");

    let box;
    useEffect(() => {
        box = document.querySelector('.container-toprated');
    })
      ...
      <div className='flex justify-center'>
        {
          ...
          (<div className=' w-full relative px-3'>
            ...
            <div className='container-toprated flex items-start gap-5 overflow-hidden scroll-smooth py-5 px-5 bg-[#0b0b0b] rounded-xl'>
                {movies.map((movie) => 
